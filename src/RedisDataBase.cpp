...
ReDB::ReDB()
{
    redis_token = new Redis("tcp://123321@127.0.0.1:6379/0?socket_timeout=50ms&connect_timeout=1s&pool_size=5");

    redis_cache = new Redis("tcp://123321@127.0.0.1:6379/1?socket_timeout=50ms&connect_timeout=1s&pool_size=5");
}
